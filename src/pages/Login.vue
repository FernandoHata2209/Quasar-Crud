<template>
  <q-page padding class="flex justify-center">
    <q-card class="my-card" style="width: 80%">
      <div class="">
        ...
        <div class="row flex flex-center">
          ...
          <q-table title="Pedidos" :rows="rows" :columns="columns" row-key="codigo" class="no-shadow col-11 q-mt-lg"
    ...
    <q-dialog v-model="dialog" persistent>
      <q-card class="col" style="width: 70%;">
        <q-card-section class="flex flex-center justify-between q-mb-md" style="border-bottom: 1px solid grey">
        ...
        <div class="row col-12 flex flex-center">
          <div class="col-11 row">
            <div class="flex col-12 justify-between">
              <q-input label="Código" outlined class="q-ma-sm"></q-input>
              <q-input label="Cliente" outlined class="q-ma-sm"></q-input>
            </div>
            <div class="flex col-12 justify-between row">
              <q-input label="Data de Entrega" outlined class="q-ma-sm "></q-input>
              <q-input label="Observação" outlined class="q-ma-sm "></q-input>
            </div>
            <div class="col-12 q-mt-md">
              <q-table title="Pedidos" :rows="rows" :columns="columns" row-key="id" class="no-shadow col-11 q-mt-lg"
                bordered selection="multiple" v-model:selected="teste" separator="cell"
                table-header-style="font-size: 1.1em" :visible-columns="['codigo', 'cliente', 'entrega', 'observacao']">
                <template v-slot:top>
                  <p class="text-h5 q-ma-md">Pedidos</p>
        ...
        <div class="q-mt-lg" style="border-top: 1px solid grey">
  ...
  data() {
    return {
      ...
      rows: [{
        ...
        cliente: 'Fernando',
        entrega: '28/10/2030',
        observacao: 'Realizar teste na maquina'
      },
      {
        codigo: 2,
        cliente: 'Fernando',
